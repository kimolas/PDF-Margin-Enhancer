...
**Note:** You must obtain a compatible build of `pdfium.js` and `pdfium.wasm`. This project is designed to work with standard Emscripten builds of PDFium.
